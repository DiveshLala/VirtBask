...
public class ModelBone {
    ...
    public ModelBone(Bone p, Bone c, String h, AnimatedModel am){
        ...
        parentJoint = p;
        childJoint = c;
//        initialParentRotation = parentJoint.getInitialRot();
//        initialVector = childJoint.getInitialPos().normalize().clone();
       initialParentRotation = parentJoint.getWorldBindRotation();
  //     System.out.println(childJoint.getName() + " " + parentJoint.getName() + " " + initialParentRotation);
