...
public class KinectClient extends Client{
    ...
    public KinectClient(Game m, String n, int p){
       super(m);
       parentClass = m; 
       serverName = n;
       portNumber = p;
    ...
    public void getKinectSensorInformation(){
        ...
        try{
            ...
            try{
                out.println(0);
                header = String.valueOf((char)in.read());
                boolean containsGesture = header.equals("G") || header.equals("B");
                while(!endOfString){
                    fromServer = in.read();
          ...
          if(header.equals("J") || header.equals("B") ){
              parentClass.setJumpingPlayer();
          }
        }
