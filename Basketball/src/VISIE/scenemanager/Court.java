...
public class Court {
    ...
    private static Vector3f midCourtLocation;
    ...
    public static void initialiseCourtDimensions(Vector3f courtTopLeft, BoundingBox b){
        ...
        System.out.println("CCC " + courtTopLeft);
    ...
    public static boolean pointIsHoopSide(Vector3f pos){
       Rectangle2D newRect =  new Rectangle2D.Double(courtDimensions.getMinX(), courtDimensions.getMinY(), courtDimensions.width/2, courtDimensions.height);
       return newRect.contains(pos.x, pos.z);
    }
  ...
  //  public static Vector3f pointisIn
    ...
    public static Vector3f calculateGoalPosition(){
        ...
        midCourtLocation = goalPosition.add(Vector3f.UNIT_X.mult(15));
    ...
    public static Vector3f getHoopLocation(){
        //manual calc
        return hoopLocation.clone();
    }
    
    public static Vector3f getPoleLocation(){
        //manual calc
        Vector3f vec = goalPosition.clone();
        return vec.add(new Vector3f(-0.5f, 0, 0));
    }
    
    public static Vector3f getMidCourtLocation(){
        return midCourtLocation;
    }
   ...
   public static String getAreaOfPoint(Vector3f vec){
       int section = getCourtSection(vec.setY(0));
       return getHorizontalCourtArea(section) + " " + getVerticalCourtArea(section);
