...
public class BasketballPlayerModel extends AnimatedModel{
 ...
 //           animationStates = new AnimationStates("config/animationstates.txt", "config/walkingstates.txt");
    }
    ...
    public void addTextures(String[] textures){
        ...
        for(int i = 0; i < textures.length; i++){
            this.addGroupTexture(i, textures[i]);
        }        
    }
...
//         modelBones.add(b9);
     ...
     @Override
      ...
      public void setTextures(ArrayList<String> text){
         
       Node n = (Node)model;   
          
       for(int i = 0; i < text.size(); i++){             
           
        TextureKey tk = new TextureKey("Models/BasketballPlayer/" + text.get(i), false);
