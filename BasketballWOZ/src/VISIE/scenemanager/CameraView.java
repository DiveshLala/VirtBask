...
public class CameraView {
    ...
    public void showImmersiveViewPoint(Vector3f characterPosition, float facingDirection, int camState){
        ...
        if(camState == 1){
                offset = Conversions.degreesToNormalizedCoordinates(facingDirection).mult(-5);
        }
   ...
   public void setupImmersiveCameras(RenderManager renderManager, Node rootNode, int numDis, int dh, int dw){
     cameraFOV = 75; // for 6-display view where 5 displays gives 180-degree field of view (240 degree total)
      mainScreen = 2;
...
//              view.setClearEnabled(true);
        ...
        angleOffset = cameraFOV/2 + 8.5f; // for 75-degree field of view camera
 //       angleOffset = cameraFOV/2; // for 360 degrees
